                            ...
                            <div class="col-md-8">
                                <div class="generic-container">
                                    <!--  <h2 class="text-center">Edit product</h2>
                                      <hr>-->
                                    <form:form method="POST" action="${pageContext.request.contextPath}/edit/${product.id}" modelAttribute="product">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <form:input path="shortDescription" type="text" class="form-control" id="shortDescription" />
